...
class IngestorCDSPHENOLOGYProcessProcessor(BaseProcessor):
    ...
    def execute(self, data):
        ...
        with s3.open(f'{self.bucket}/data-ingestor/spain/agro_indicator/{self.variable}/{self.variable}_metadata.json', 'w') as file:
        ...
        tif_file_paths = sorted([os.path.join(var_base_path, f) for f in os.listdir(var_base_path) if f.endswith('.tif')])
