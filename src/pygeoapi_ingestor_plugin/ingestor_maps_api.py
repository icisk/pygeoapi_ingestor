...
PROCESS_METADATA = {
    ...
    "description": {"en": "creates maps from layers in postgis db"},
    ...
    "outputs": {
        ...
        "value": {"title": "Value", "description": "status msg describing the process", "schema": {"type": "string"}},
    },
    "example": {
        "inputs": {
...
class IngestorAPIMAPSProcessProcessor(BaseProcessor):
                ...
                "providers": [
                    {
                        "type": "map",
                        "name": "MapScript",
                        "options": {"type": self.maps_geom_type, "layer": self.layer_name, "style": self.sld_path},
    ...
    def execute(self, data):
        ...
        outputs = {"id": "api_maps", "value": "done"}
