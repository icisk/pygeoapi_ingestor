...
parser = argparse.ArgumentParser(
    description="reads .json file that contains ingestor process name 'process' and process inputs 'payload' "
)
...
logging.basicConfig(
    format="[%(asctime)s] [%(levelname)s] %(message)s", level=logging.NOTSET, stream=sys.stdout, force=True
)
